    ...
    return (
        <div className="ml-4">
            ...
            >
                ...
                <Icon name="folder" className="w-5 h-5 text-yellow-500 mr-2" />
                <span>{node.name}</span>
            </div>
                ...
                {generatedLink ? (
                    <div>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button onClick={copyToClipboard} className="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
    ...
    React.useEffect(() => {
        if (isOpen && file) {
            ...
            if (['png', 'jpg', 'jpeg', 'gif', 'webp'].includes(extension)) {
                ...
                setPreviewContent({ type: 'unsupported', message: 'DOCX 파일은 브라우저에서 직접 미리보기를 지원하지 않습니다. 파일을 다운로드하여 확인해주세요.' });
                setIsLoading(false);
            } else {
